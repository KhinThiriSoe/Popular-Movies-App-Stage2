...
import com.khinthirisoe.popularmoviesappstage2.youtube.YouTubePlayerActivity
import com.khinthirisoe.popularmoviesappstage2.utils.Config
import kotlinx.android.synthetic.main.list_videos.view.*


class TrailersAdapter(private val mContext: Context, private var mListData: ArrayList<VideoResult>) :
