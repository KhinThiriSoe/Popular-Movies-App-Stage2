package com.khinthirisoe.popularmoviesappstage2.movies.overview.presenter
...
class MoviePresenter constructor(var interactor: MovieRepository) : MainContract.Presenter, KoinComponent {
